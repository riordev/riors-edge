...
2. Red Basin/Station Zero/Port Meridian prototypes and Station priority hunt landed; Red Basin recovery/extraction also landed; next content acceptance is real return Rifts, route pacing and region scenery. Refine exposed boundaries and repeated cover. Anchor surroundings/work-area dressing landed but remains blockout art.
