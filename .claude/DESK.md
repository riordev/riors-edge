...
- [ ] Validate sustained ability-build throughput and authored encounter composition. The fixed progression parity pin remains red; broader audiovisual polish remains open.
  - Actual first-wave enemy AI now has a live delivery regression with normal starting resources. The level-one converted rifle kills3/12 before death at8.05s and activates Rot; paid Fracture/Rot kills2/12 before death at7.65s without reaching Rot activation. This basic driver approaches and aims but does not evade; results prove delivery and threat, not player skill, successful clears or balance. Entry is free despite area5, so next compare guaranteed starter gear and a naturally earned Fernhall progression snapshot rather than assuming a level5 kit. Sympathetic and standalone feedback audits found no wiring defect; buffed traveling Fracture and audible mix still need encounter/playtest evidence.
