...
- **Live Entropy Rift diagnostic:** New runtime test enters the production first wave with moving/attacking enemies, real projectiles, paid abilities, conversion and incoming player status ticks. Ammunition counts stock debits without treating delayed starting fill as negative shots. Final rifle row spends37rounds, deals1485.02health damage and observes Rot; ability row casts4Fracture/1Rot, deals1069.92 and spends0rounds. Both die with the basic non-evasive driver; no tuning or parity targets changed. Build passed;672 declared/started,669 passed,3known,0unexpected via quarantine auditor. STATE unchanged under host-Python quarantine.
- **Substation formation and Patience sustain:** Outdoor encounters now distribute4/3/4 with the same11 enemies and one entry elite. Substation has a central Warden, opposite melee flankers and a Skirmisher behind actual authored full-height cover. Two-visit runtime checks preserve grounding, capsule clearance, initial/feedstock quest completion, XP and no duplicate population; actual eye-height trace proves the cover blocker. Targeted1080p captures show formation and engagement; blockout art and combat feel remain unfinished. Patience2 is bought through normal gates from an explicit first-benchmark entitlement fixture, not a campaign-playthrough claim; Fracture sustains roughly200DPS rather than95 in the neutral stationary60s run. No tuning or parity-pin changes. Build passed;671 started,668 passed,3known,0unexpected via quarantine auditor. STATE unchanged under host-Python quarantine.
