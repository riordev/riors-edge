...
- [x] Grounded local movement plays five existing recorded concrete footsteps through one shared, settings-controlled director. Distance cadence rejects airborne/menu/dead/traversal/teleport movement. Native component-to-PCM and all 12 voice volume checks pass. Surface-specific selection and audible mix acceptance remain outstanding; STATE unchanged under Python quarantine.
