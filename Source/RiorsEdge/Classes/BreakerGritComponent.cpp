...
void UBreakerGritComponent::HandleProgressionChanged()
{
    ...
    {
        RankSlowBleed = Progression->GetNodeRank(TEXT("Tank.Leech.SlowBleed"), EBreakerPointCurrency::DoctrinePoints);
        RankFeedTheWound = Progression->GetNodeRank(TEXT("Tank.Leech.FeedTheWound"), EBreakerPointCurrency::DoctrinePoints);
        RankTransfusion = Progression->GetNodeRank(TEXT("Tank.Leech.Transfusion"), EBreakerPointCurrency::DoctrinePoints);
        ...
        RankFooting = Progression->GetNodeRank(TEXT("Tank.Bastion.Footing"), EBreakerPointCurrency::DoctrinePoints);
        RankHeldGround = Progression->GetNodeRank(TEXT("Tank.Bastion.HeldGround"), EBreakerPointCurrency::DoctrinePoints);
