...
public:
    ...
    // ---- Currency drops (see the block above GetGatedRarityProbabilities'
    // struct declarations for the full pipeline description) --------------
    ...
    UFUNCTION(BlueprintCallable, Category="Items|Drops")
    static FBreakerForgeWallet RollCurrencyDrop(int32 RandomSeed, int32 ItemLevel, EBreakerMonsterRank Rank,
