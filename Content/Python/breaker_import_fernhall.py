...
# The living yard's 167 pieces, plus the ruined target's dressing chunks. The
# ruin is ADDITIVE — same 167 names, the same measured boxes, with dress_ruin_*
...
EXPECTED_TOTAL = 215 if RUINED else 167
