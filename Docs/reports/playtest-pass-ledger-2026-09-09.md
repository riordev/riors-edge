...
- Overdrive revoke: full/tail outgoing, movement, resource loop/floor and variant dash/range leases now end immediately on grant removal; timers and callbacks detach before window closure. Paid native class ultimate, earned nine-point Duration route and real movement funding cover base full/tail/no-refund/no-resurrection. Independent review caught and fixed two variant permission omissions; variant-specific acquisition is not runtime-claimed. Build/full suite858 passing,3 expected failures,0 unexpected; status regenerated.
